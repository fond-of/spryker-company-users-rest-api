...
class CompanyUsersRestApiConfig
{
    ...
    public const RESPONSE_CODE_COMPANY_USER_FAILED_TO_SAVE = '1301';
    public const RESPONSE_CODE_COMPANY_USER_NOT_FOUND = '1303';

    public const RESPONSE_DETAILS_COMPANY_USER_DATA_INVALID = 'Company user data is invalid.';
    public const RESPONSE_DETAILS_COMPANY_USER_FAILED_TO_SAVE = 'Failed to save company user.';
