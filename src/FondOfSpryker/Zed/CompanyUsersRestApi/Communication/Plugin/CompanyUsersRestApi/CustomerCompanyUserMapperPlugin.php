 ...
 */
class CustomerCompanyUserMapperPlugin extends AbstractPlugin implements CompanyUserMapperPluginInterface
{
    /**
     * Specification:
    ...
    public function map(
        ...
        return $this->getFacade()->mapCustomerToCompanyUser(
